...
public class MarksController {
    ...
    /** ADMIN, FACULTY — upload single mark */
    @PostMapping
    ...
    /** STUDENT — own marks. ADMIN, FACULTY — any student */
    ...
    /** ADMIN, FACULTY — batch marks */
    @GetMapping("/batch/{batchId}/subject/{subjectId}")
    public ResponseEntity<ApiResponse<List<Marks>>> getBatchMarks(
            @RequestHeader("X-User-Role") String role,
        ...
        return ResponseEntity.ok(ApiResponse.success("Batch marks fetched",
                marksService.getBatchMarks(batchId, subjectId, examType)));
    }
